      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="{{ route('admin.students')}}" class="nav-link {{ (request()->is('admin/students*')) ? 'active' : '' }}">
             ...
             <!--li class="nav-item">
                <a href="{{ route('admin.perscription')}}" class="nav-link {{ (request()->is('admin/perscription*')) ? 'active' : '' }}">
                  <i class="nav-icon fas fa-user"></i>
                  <p>
                  Perscriptions
                  </p>
